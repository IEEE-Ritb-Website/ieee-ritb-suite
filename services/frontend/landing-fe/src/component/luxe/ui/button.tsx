  ...
  },
  {
    ...
    component: ({ children, className, ...props }) => (
      <button
        {...props}
        className={cn(
          "relative rounded-xl border border-primary/10 bg-main-background px-4 py-2 duration-200 hover:bg-primary",
          className,
        )}
      >
        <div
        ...
        >
          <motion.div
            className={cn(
              "absolute aspect-square bg-gradient-to-r from-transparent via-neutral-300 to-transparent",
        ...
        <span className="relative z-10 text-primary-invert">{children}</span>
      </button>
    ),
  },
  {
    ...
    component: ({ children, className, ...props }) => {
      return (
        <button
          {...props}
          className={cn(
            "group relative overflow-hidden rounded-xl px-4 py-2 text-primary-invert duration-200",
