  ...
  return (
    <div
      ...
      style={
        accentColor
          ? {
              background: `linear-gradient(135deg, ${accentColor}80, ${accentColor}30)`,
            }
          : undefined
      }
    >
...
function ExecomCard({ member, accentColor, variants }: ExecomCardProps) {
  return (
    ...
    >
      {/* Solaris Holographic Overlays for Execom */}
      <div className="card-holographic-sheen" />
      <div className="card-corner corner-tl" />
      <div className="card-corner corner-tr" />
      <div className="card-corner corner-bl" />
...
export default function ChapterTeam() {
  ...
  const { officers, execoms } = useMemo(() => {
    const officerList = sortMembersByPosition(
      members.filter((m) => !isExecomPosition(m.position)),
    );
    const execomList = members.filter((m) => isExecomPosition(m.position));
  ...
  return (
    <>
      ...
      >
        ...
        <m.section
          className="ct-hero"
          aria-labelledby="ct-chapter-name"
        ...
        >
          ...
          {!shouldReduceMotion && (
            <div className="ct-hero-rings" aria-hidden="true">
              <div
                className="ct-ring ct-ring-1"
                style={{ borderColor: `${accentColor}50` }}
              />
              <div
                className="ct-ring ct-ring-2"
                style={{ borderColor: `${accentColor}35` }}
              />
              <div
                className="ct-ring ct-ring-3"
          ...
          <div className="ct-hero-text">
            ...
            <h1 id="ct-chapter-name" className="ct-hero-title">
              {chapter.name}
            </h1>
        ...
        {execoms.length > 0 && (
          <>
            <div
              ...
              role="separator"
              aria-label="Execom Members section"
            >
            ...
            {/* ── Execom Grid ───────────────────────────── */}
            <section
              className="ct-section ct-execom-section"
              aria-labelledby="ct-execom-heading"
            >
              <div className="ct-section-container">
                <m.div
                  variants={safeContainer}
                  ...
                  viewport={{ once: true, margin: "-60px" }}
                >
                  <h2 id="ct-execom-heading" className="sr-only">
                    Execom Members
                  </h2>
