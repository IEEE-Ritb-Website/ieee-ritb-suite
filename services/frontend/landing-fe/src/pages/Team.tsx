...
import { SB_SENIOR_POSITIONS, SB_VICE_POSITIONS, PROFILE_BASE_URL } from '@/data/teamData';
...
function MemberAvatar({ src, name, isSenior }: MemberAvatarProps) {
    ...
    return (
        <div className={`member-avatar-ring ${isSenior ? 'member-avatar-ring-senior' : ''}`}>
    ...
    return (
        ...
        >
            ...
            <div className="member-info">
                ...
                <span className={`member-position-badge ${isSenior ? 'badge-senior' : 'badge-vice'}`}>
                    {member.position}
                </span>
                <span className="member-meta">{member.department} · {member.year} Year</span>
            </div>
...
export default function Team() {
    ...
    const seniorOfficers = members.filter((m) => SB_SENIOR_POSITIONS.has(m.position));
    ...
    return (
        <>
            ...
            <div className="team-page">
                        ...
                        >
                            <m.div className="team-section-header" variants={safeItem}>
                                ...
                                <p className="team-section-desc">
                                    Leading the {new Date().getFullYear()}-{String(new Date().getFullYear() + 1).slice(2)} term.
                                </p>
                            </m.div>
                ...
                {/* ── Chapter Directory ─────────────────────── */}
                <section className="team-section team-section-chapters" aria-labelledby="chapters-directory-heading">
                    <div className="team-section-container">
                        <m.div
                            variants={safeChapters}
                            initial="hidden"
                            animate={animState}
                        >
                            <m.div className="team-section-header" variants={safeItem}>
                                <span className="section-overline">Our Ecosystem</span>
                                <h2 id="chapters-directory-heading" className="team-section-title">
                                    Explore Chapters
                                </h2>
                                <p className="team-section-desc">
                            ...
                            <m.div className="chapter-directory-grid" variants={safeContainer}>
                                {Chapters.map((chapter) => (
                                    <m.div key={chapter.acronym} variants={safeCard}>
                                        ...
                                        >
                                            ...
                                            <div className="chapter-dir-border" style={{ borderColor: chapter.color }} />
                                        </Link>
                                    </m.div>
                                ))}
                            </m.div>
